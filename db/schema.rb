...
ActiveRecord::Schema.define(version: 20160509212429) do
  ...
  add_index "cities", ["review_id"], name: "index_cities_on_review_id", using: :btree
  ...
  add_foreign_key "cities", "reviews"
